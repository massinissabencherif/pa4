<template>
  <div>
    ...
    <div class="max-w-[1100px] mx-auto px-6 py-8">
      ...
      <div v-else-if="!stats" style="text-align:center;padding:80px 0;font-family:'Courier New',monospace;font-size:12px;letter-spacing:3px;color:#fff;text-transform:uppercase;">
      ...
      <template v-else>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-px mb-px" style="background:#2a2a2a;margin-bottom:32px;">
          <div style="background:#111;padding:24px 20px;text-align:center;">
            ...
            <p style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:8px;">Terminés</p>
          </div>
          <div style="background:#111;padding:24px 20px;text-align:center;">
            ...
            <p style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:8px;">En cours</p>
          </div>
          <div style="background:#111;padding:24px 20px;text-align:center;">
            <p style="font-family:impact,sans-serif;font-size:36px;letter-spacing:1px;color:#fff;line-height:1;">{{ stats.counts.toRead }}</p>
            <p style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:8px;">À lire</p>
          </div>
          <div style="background:#111;padding:24px 20px;text-align:center;">
            ...
            <p style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#fff;margin-top:8px;">Avis postés</p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-px mb-px" style="background:#2a2a2a;margin-bottom:24px;">
          ...
          <div style="background:#111;padding:24px;">
            <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:4px;text-transform:uppercase;color:#e02020;margin-bottom:6px;">Activité</div>
            ...
            <div class="flex items-end gap-1" style="height:80px;">
              ...
              >
                ...
                />
                <span style="font-size:9px;font-family:'Courier New',monospace;color:#fff;transform:rotate(45deg);transform-origin:left;display:block;width:12px;">{{ m.label }}</span>
              </div>
            </div>
          </div>
          ...
          <div style="background:#111;padding:24px;display:flex;flex-direction:column;gap:24px;">
            <div>
              <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:4px;text-transform:uppercase;color:#e02020;margin-bottom:6px;">Note</div>
              ...
              <p v-else style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:2px;color:#fff;text-transform:uppercase;">Aucun avis posté</p>
            </div>
            <div>
              <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:4px;text-transform:uppercase;color:#e02020;margin-bottom:12px;">Communauté</div>
              <div class="flex gap-8" style="font-family:'Courier New',monospace;">
                <div>
                  ...
                  <span style="font-size:11px;letter-spacing:2px;color:#fff;text-transform:uppercase;margin-left:8px;">suivis</span>
                </div>
                <div>
                  <span style="font-family:impact,sans-serif;font-size:26px;letter-spacing:1px;color:#fff;">{{ stats.counts.followers }}</span>
                  <span style="font-size:11px;letter-spacing:2px;color:#fff;text-transform:uppercase;margin-left:8px;">abonnés</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-px mb-px" style="background:#2a2a2a;margin-bottom:24px;">
          ...
          <!-- Top genres -->
          <div style="background:#111;padding:24px;">
            <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:4px;text-transform:uppercase;color:#e02020;margin-bottom:6px;">Préférences</div>
            ...
            <div v-if="stats.topGenres.length" class="space-y-3">
              <div v-for="g in stats.topGenres" :key="g.genre">
                <div class="flex justify-between" style="font-family:'Courier New',monospace;font-size:11px;letter-spacing:1px;margin-bottom:6px;">
                  <span style="color:#fff;">{{ g.genre }}</span>
                  <span style="color:#fff;">{{ g.count }}</span>
                </div>
            ...
            <p v-else style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:2px;color:#fff;text-transform:uppercase;">Lis des comics pour voir tes genres préférés.</p>
          </div>
          ...
          <div style="background:#111;padding:24px;">
            ...
            <div v-if="stats.topAuthors.length" class="space-y-3">
              <div v-for="a in stats.topAuthors" :key="a.author">
                <div class="flex justify-between" style="font-family:'Courier New',monospace;font-size:11px;letter-spacing:1px;margin-bottom:6px;">
                  <span style="color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:70%;">{{ a.author }}</span>
            ...
            <p v-else style="font-family:'Courier New',monospace;font-size:12px;letter-spacing:2px;color:#fff;text-transform:uppercase;">Lis des comics pour voir tes auteurs préférés.</p>
          </div>
        </div>
        ...
        <div style="background:#111;border:1px solid #2a2a2a;border-top:2px solid #e02020;padding:24px;">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-px" style="background:#2a2a2a;">
            ...
            >
              ...
              <span style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:1px;text-transform:uppercase;color:#fff;">{{ badge.name }}</span>
              <span style="font-family:'Courier New',monospace;font-size:9px;letter-spacing:1px;color:#fff;">{{ new Date(badge.earnedAt).toLocaleDateString('fr-FR') }}</span>
              <div class="badge-tooltip">
                <div style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:1px;text-transform:uppercase;color:#e02020;margin-bottom:4px;">{{ badge.name }}</div>
                <div style="font-family:'Courier New',monospace;font-size:11px;line-height:1.5;color:#fff;">{{ badge.description }}</div>
                <div style="margin-top:6px;font-family:'Courier New',monospace;font-size:9px;letter-spacing:1px;color:#fff;text-transform:uppercase;">Obtenu le {{ new Date(badge.earnedAt).toLocaleDateString('fr-FR') }}</div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <span style="font-family:'Courier New',monospace;font-size:10px;letter-spacing:1px;text-transform:uppercase;color:#fff;">???</span>
            </div>
          </div>
        </div>
